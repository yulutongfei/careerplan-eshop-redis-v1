package com.ruyuan.careerplan.goodscart.aspect;
...
public class ParamsValidatorAspect {
     ...
     */
    @Pointcut("@annotation(com.ruyuan.careerplan.goodscart.annotation.ParamsValidate)")
    ...
    public Object around(ProceedingJoinPoint point) throws Throwable {
        ...
        for (Object parameterValue : parameterValues) {
            ...
            if (!CollectionUtils.isEmpty(validateResult)) {
                ...
                throw new BaseBizException(CookbookCartErrorCodeEnum.PARAM_CHECK_ERROR, sb.substring(0, sb.length()-1));
            }
        }
        try {
