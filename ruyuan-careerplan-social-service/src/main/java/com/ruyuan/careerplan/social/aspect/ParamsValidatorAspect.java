package com.ruyuan.careerplan.social.aspect;

import com.alibaba.fastjson.JSON;
import com.ruyuan.careerplan.common.exception.BaseBizException;
import com.ruyuan.careerplan.social.enums.SocialErrorCodeEnum;
...
public class ParamsValidatorAspect {
     ...
     */
    @Pointcut("@annotation(com.ruyuan.careerplan.social.annotation.ParamsValidate)")
    ...
    public Object around(ProceedingJoinPoint point) throws Throwable {
        ...
        for (Object parameterValue : parameterValues) {
            ...
            if (!CollectionUtils.isEmpty(validateResult)) {
                ...
                throw new BaseBizException(SocialErrorCodeEnum.PARAM_CHECK_ERROR, sb.substring(0, sb.length()-1));
            }
        }
        try {
